...
class Sinigang:
    ...
    def __str__(self):
        return f"Ang paborito kong sinigang ay may {self.meat}, {self.tomato}, {self.onion}, {self.fish_sauce}, {self.vegetable}, {self.tamarind},{self.__sili}"

sigang1 = Sinigang("Baboy", "1 tomato", "1 red onion", "fish sauce", "radish", "tamarind", "3 siling green")
print(sigang1.__sili)